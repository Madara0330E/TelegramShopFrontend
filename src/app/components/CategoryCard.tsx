      ...
      <div className="relative w-full aspect-square">
        ...
        {category.isNew && (
          ...
          >
            ...
            />
            <span className="text-[#EFEDF6]  text-[4.1667vw] text-base font-semibold leading-normal">Новое</span>
           
          </span>
        )}
      </div>
      <div className="flex justify-center items-center mt-0.5 max-w-[22.14vw]">
        <p className="text-[#EFEDF6] text-[3.6458vw] text-center w-full break-words whitespace-normal">
          {category.name}
        </p>
      </div>
    </div>
