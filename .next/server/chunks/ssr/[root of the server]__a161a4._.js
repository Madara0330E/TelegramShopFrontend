...
;
function Home() {
    const [validationMessage, setValidationMessage] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])('Проверка...');
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        // Проверяем, загружен ли Telegram.WebApp
        if (!window.Telegram || !window.Telegram.WebApp) {
            setValidationMessage('Telegram Web App не загружен.');
            return;
        }
        const tgApp = window.Telegram.WebApp;
        // Проверяем, готов ли Telegram.WebApp
        if (!tgApp.ready) {
            setValidationMessage('Telegram Web App не готов.');
            return;
        }
        // Если initData отсутствует
        ...
        const validateUser = async ()=>{
            try {
                ...
                if (response.ok) {
                    setValidationMessage('Пользователь успешно проверен!');
                } else {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            fileName: "[project]/src/app/components/TelegramInit.js",
            lineNumber: 54,
            columnNumber: 7
        }, this)
    }, void 0, false, {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__a161a4._.js.map