(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_e8e9ad._.js", {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$twa$2d$dev$2f$sdk$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/@twa-dev/sdk/dist/index.js [app-client] (ecmascript)");
;
...
function Home() {
    _s();
    const [validationStatus, setValidationStatus] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('Проверка...');
    const [validationColor, setValidationColor] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('text-gray-600');
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Home.useEffect": ()=>{
            // Инициализация Telegram Web App
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$twa$2d$dev$2f$sdk$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["WebApp"].ready();
            // Проверка наличия initData
            if (!__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$twa$2d$dev$2f$sdk$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["WebApp"].initData || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$twa$2d$dev$2f$sdk$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["WebApp"].initData.length === 0) {
                setValidationStatus('Ошибка: нет данных от Telegram!');
                setValidationColor('text-red-500');
                return;
            }
            console.log('Telegram initData:', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$twa$2d$dev$2f$sdk$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["WebApp"].initData);
            // Отправка данных на сервер для валидации
            const validateUser = {
                "Home.useEffect.validateUser": async ()=>{
                    try {
                        const response = await fetch('https://cardstradebackend20250302140309-g0abauhjbbheehh0.israelcentral-01.azurewebsites.net/api/v1/telegram/validate', {
                            ...
                            body: JSON.stringify({
                                InitData: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$twa$2d$dev$2f$sdk$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["WebApp"].initData
                            })
                        });
                        if (!response.ok) {
...
_s(Home, "z/kgz1XXc3h9J+fICxfq6uF5bK0=");
_c = Home;
var _c;
...
"[project]/node_modules/@twa-dev/sdk/dist/telegram-web-apps.js [app-client] (ecmascript)": (function(__turbopack_context__) {
...
(function() {
    ...
    function urlAppendHashParams(url1, addHash) {
        // url looks like 'https://game.com/path?query=1#hash'
        // addHash looks like 'tgShareScoreUrl=' + encodeURIComponent('tgb://share_game_score?hash=very_long_hash123')
        var ind = url1.indexOf('#');
        if (ind < 0) {
            // https://game.com/path -> https://game.com/path#tgShareScoreUrl=etc
            return url1 + '#' + addHash;
        }
        var curHash = url1.substr(ind + 1);
    ...
    ;
    function openProtoUrl(url1) {
        if (!url1.match(/^(web\+)?tgb?:\/\/./)) {
            return false;
        }
...
(function() {
    ...
    WebApp.openLink = function(url1, options) {
        var a = document.createElement('A');
        a.href = url1;
        if (a.protocol != 'http:' && a.protocol != 'https:') {
            console.error('[Telegram.WebApp] Url protocol is not supported', url1);
    ...
    WebApp.openTelegramLink = function(url1, options) {
        var a = document.createElement('A');
        a.href = url1;
        if (a.protocol != 'http:' && a.protocol != 'https:') {
            console.error('[Telegram.WebApp] Url protocol is not supported', url1);
        ...
        if (a.hostname != 't.me') {
            console.error('[Telegram.WebApp] Url host is not supported', url1);
            throw Error('WebAppTgUrlInvalid');
        }
...
"[project]/node_modules/@twa-dev/sdk/dist/sdk.js [app-client] (ecmascript)": (function(__turbopack_context__) {
...
__turbopack_require__("[project]/node_modules/@twa-dev/sdk/dist/telegram-web-apps.js [app-client] (ecmascript)");
var telegramWindow = window;
exports.WebApp = telegramWindow.Telegram.WebApp; //# sourceMappingURL=sdk.js.map
}}),
"[project]/node_modules/@twa-dev/sdk/dist/index.js [app-client] (ecmascript)": (function(__turbopack_context__) {
...
var sdk_1 = __turbopack_require__("[project]/node_modules/@twa-dev/sdk/dist/sdk.js [app-client] (ecmascript)");
exports.default = sdk_1.WebApp; //# sourceMappingURL=index.js.map
}}),
}]);

//# sourceMappingURL=_e8e9ad._.js.map